...
export const RegisterPage: React.FC<RegisterPageProps> = ({
  ...
  description = "Cadastre-se para começar",
  heroImageSrc,
  testimonials = [],
  onGoogleSignIn,
  onLogin,
  ...
  const validateForm = () => {
    ...
    if (!formData.senha.trim()) errors.push("Senha é obrigatória");
    ...
    <div className="h-[100dvh] flex flex-col md:flex-row font-geist w-[100dvw]">
            ...
            <form className="space-y-5" onSubmit={handleSubmit}>
              ...
              <div>
                ...
                <select
                  ...
                  onChange={handleChange}
                  disabled={loading}
                  className="w-full p-4 rounded-2xl border border-border bg-foreground/5 backdrop-blur-sm focus:border-violet-400/70 focus:bg-violet-500/10 focus:outline-none disabled:opacity-50 disabled:cursor-not-allowed"
                >
              ...
              {/* WhatsApp */}
              <div>
                <label className="text-sm font-medium text-muted-foreground">WhatsApp (Opcional)</label>
                <GlassInputWrapper>
                  <input
                    name="whatsapp"
                    type="text"
              ...
              {/* Endereço */}
              <div>
                <label className="text-sm font-medium text-muted-foreground">Endereço (Opcional)</label>
                <GlassInputWrapper>
                  <input
                    name="endereco"
                    type="text"
            ...
            {onGoogleSignIn && (
              <>
                <div className="relative flex items-center justify-center">
                  ...
                  <span className="absolute bg-background px-4 text-sm text-muted-foreground">ou</span>
                </div>
      ...
      {heroImageSrc && (
        <section className="hidden md:block flex-1 relative p-4">
          <div className="animate-slide-right animate-delay-300 absolute inset-4 rounded-3xl bg-cover bg-center overflow-hidden">
            <img 
              src={heroImageSrc} 
              alt="Hero"
