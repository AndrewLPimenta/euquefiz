...
export interface FloatingIconsHeroProps {
  ...
  ctaHref: string;
  icons: IconProps[];
  // Nova prop para o ID da seção de destino do scroll
...
>(({ 
  ...
  ctaHref, 
  icons, 
  targetSectionId = 'products-section', // ID padrão para a seção de produtos
  ...props 
}, ref) => {
  ...
  // Função para scroll suave até a seção de destino
      ...
      <div className="relative z-10 text-center px-4">
        ...
        <div className="mt-10">
          <Button
            ...
            size="lg"
            className="px-8 py-6 text-base font-semibold gap-2 group"
          >
            {ctaText || "Explorar produtos abaixo"}
